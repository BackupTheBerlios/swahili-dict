...
return array(
	...
	'This user\'s email adress already exists.' => 'Die Benutzer-E-Mail-Adresse existiert bereits.',
	'You registered from {site_name}' => 'Du bist auf {site_name} registriert',
	'Please activate you account go to {activation_url}' => 'Um Ihr Konto zu aktivieren, rufen Sie folgende URL auf: {activation_url}',
	...
	'Variable name may consist of a-z, 0-9, underscores, begin with a letter.'=>'Variable Name kann aus a-z bestehen, 0-9, Unterstriche, mit einem Buchstaben beginnen.',
	"Length of ' + n + ' must be between '+min+' and '+max+'."=>"Länge des ' + n + ' muss zwischen '+min+' und '+max+' sein.",
	...
	'Thank you for your registration. Contact Admin to activate your account.' =>  'Vielen Dank für Ihre Anmeldung. Kontaktieren sie den Administrator, um Ihr Konto zu aktivieren.',
	...
	'Field Size min' => 'minimale Feldgröße',
	'Required' => 'Benötigt',
	'Match' => 'Treffer',
	'Range' => 'Bereich',
	...
	'Field name on the language of "sourceLanguage".' => 'Feldname in der Sprache der "SourceLanguage".',
