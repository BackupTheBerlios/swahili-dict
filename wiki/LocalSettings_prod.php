...
$wgLogo             = "$wgStylePath/common/images/logo_wiki.png";
...
## Adding additional custom namespaces
$wgExtraNamespaces[100] = "Admin";
...
# -------------------------------------------------------------------
# UsabilityInitiative Extension for MediaWiki 1.16.x settings start:
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# UsabilityInitiative Extension for MediaWiki 1.16.x settings end
# -------------------------------------------------------------------

require_once( "$IP/extensions/awc/forums/awc_forum.php" ); # AWC Forum Extension
require_once("$IP/extensions/awc/forums/extensions/Add_Sidebar.php"); # Unofficial Fix for sidebar-problems in MediaWiki 1.16
