...
define('awcs_forum_lang_default', 'de');
...
/*PM info in personal-bar Config funktioniert nicht auf false lassen oder auskommentieren/loeschen */
define('awcs_show_SidebarUrls', false); //Show Forum Navigation in Sidebar.
